    ...
    return html`
      ...
      <app-header condenses reveals effects="waterfall">
        ...
        <nav class="toolbar-list">
          <a ?selected="${this._page === 'scanner'}" href="/scanner">Scanner</a>
          <a ?selected="${this._page === 'collections'}" href="/collections">Collections</a>
          <a ?selected="${this._page === 'options'}" href="/options">Options</a>
        </nav>
      </app-header>
